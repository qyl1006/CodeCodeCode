...
<form action="/employee/list.do" method="post">
    ...
    <a href="/employee/input.do">增加</a><<br>

    编号 姓名 邮箱 年龄  操作 <<br>
    <c:forEach items="${resultPage.data}" var="emp">
    ...
    <a href="/employee/list.do?currentPage=${resultPage.prevPage}">上一页</a>
    <a href="/employee/list.do?currentPage=${resultPage.nextPage}">下一页</a>
    <a href="/employee/list.do?currentPage=${resultPage.endPage}">尾页</a>
    总共${resultPage.dataCount}条
